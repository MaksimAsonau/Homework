...
public class CalculatorWithCounterAutoAgregationTest {
    ...
    private final CalculatorWithMathCopy calcForConstructor = new CalculatorWithMathCopy();
    private final CalculatorWithCounterAutoAgregation calculator =
            new CalculatorWithCounterAutoAgregation(calcForConstructor);
